        ...
        {estagiario ? (
          <EstagiarioForm
            ...
            initialData={{
              ...
              escola_endereco: String(estagiario.escola_endereco ?? ""),
              escola_bairro: String(estagiario.escola_bairro ?? ""),
              escola_cnpj: String(estagiario.escola_cnpj ?? ""),
              escola_inscricao_estadual: String(estagiario.escola_inscricao_estadual ?? ""),
